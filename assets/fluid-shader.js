/**
 * The fluid wallpaper shader, extracted verbatim from the harness package.
 *
 * Source: WorkbenchFluid.tsx
 * Source sha256: sha256:1b070ec37c73b3a5
 * Extracted: 2026-09-22 by .agents/skills/dsh-beyond-glass-release/extract-fluid-shader.py
 *
 * Do not edit this file. Re-run the extractor after changing the shader, then
 * verify with `--check`.
 */
window.BG_FLUID = {
